 ...
 * @author joliveira
 */
@WebServlet(name = "Promocao", urlPatterns = {"/Promocao"})
public class Promocao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Produto> promocoes = Utils.ListarPaginaInicialPromocoes();
        
        request.setAttribute("promocoes", promocoes);
        RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/promocoes.jsp");
